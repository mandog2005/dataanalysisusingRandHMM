...
df51 <- df[df$Date >= "2008-12-13" & df$Date <= "2008-12-19",]
df52 <- df[df$Date >= "2008-12-20" & df$Date <= "2008-12-26",]
df53 <- df[df$Date >= "2008-12-27" & df$Date <= "2008-12-31",]



ggplot(df1, aes(x = Time, y = Global_intensity)) +
    geom_line()


#week 1-5

week1.intesity = zoo(df1$Global_intensity, 
             order.by = seq(as.POSIXct("2008-01-01 00:00:00"), length=10080, by="min"))

week2.intesity = zoo(df2$Global_intensity, 
             order.by = seq(as.POSIXct("2008-01-08 00:00:00"), length=10080, by="min"))

week3.intesity = zoo(df3$Global_intensity, 
             order.by = seq(as.POSIXct("2008-01-15 00:00:00"), length=10080, by="min"))

week4.intesity = zoo(df4$Global_intensity, 
             order.by = seq(as.POSIXct("2008-01-22 00:00:00"), length=10080, by="min"))

week5A.intesity = zoo(df5A$Global_intensity, 
...
#week 6-10
week6.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-02-10 00:00:00"), length=10080, by="min"))

week7.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-02-17 00:00:00"), length=10080, by="min"))


week8.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-02-24 00:00:00"), length=10080, by="min"))


week9.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-03-02 00:00:00"), length=10080, by="min"))


week10.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-03-09 00:00:00"), length=10080, by="min"))

#week 11-15

week11.intesity = zoo(df11$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-03-16 00:00:00"), length=10080, by="min"))

week12.intesity = zoo(df12$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-03-22 00:00:00"), length=10080, by="min"))


week13.intesity = zoo(df13$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-03-29 00:00:00"), length=10080, by="min"))


week14.intesity = zoo(df14$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-04-05 00:00:00"), length=10080, by="min"))


week15.intesity = zoo(df15$Global_intensity, 
                      order.by = seq(as.POSIXct("2008-04-12 00:00:00"), length=10080, by="min"))

#week 16-20
week16.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-02-03 00:00:00"), length=10080, by="min"))

week17.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-02-03 00:00:00"), length=10080, by="min"))


week18.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-02-03 00:00:00"), length=10080, by="min"))


week19.intesity = zoo(df6$Global_intensity, 
                     order.by = seq(as.POSIXct("2008-02-03 00:00:00"), length=10080, by="min"))


week20.intesity = zoo(df6$Global_intensity, 
                      order.by = seq(as.POSIXct("2008-02-03 00:00:00"), length=10080, by="min"))
...
sma5 = rollmean(week5.intensity,10)
...
sma53 = rollmean(week53.intensity,10)
